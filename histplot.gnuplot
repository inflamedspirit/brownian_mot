...
set term x11
set output 'hist.png'
plot 'temp1.dat' u 1:2 w points t "Escape Times", 'temp2.dat' w points t "Return Times", levy(x), levy2(x), pow32(x), pow32two(x), wes(x)
# , exponential(x), lorentzian(x),  lorentzian2(x),
